...
<script>
    ...
    function next(x){
            ...
            if(  $("#next"+y).parent().children('div').children('div').hasClass('selected')) {
                if(($("#next"+y).parent().children('div').children('div').hasClass('Q1Autre') && $('.Q1Autre').hasClass('selected')) || 
                ($("#next"+y).parent().children('div').children('div').hasClass('Q4Autre') && $('.Q4Autre').hasClass('selected') ||
                ($("#next"+y).parent().children('div').children('div').hasClass('Q5Autre') && $('.Q5Autre').hasClass('selected')) ||
                ($("#next"+y).parent().children('div').children('div').hasClass('Q9Autre') && $('.Q9Autre').hasClass('selected')) ))
                { 
...
<body  onload="load('de')"  >
<form action="deviseOnline.php" method="POST" name="form1" id="myForm" >
                    ...
                    <fieldset class="fieldset12 d-none" >
                        <div class="form-card">
                            ...
                            <div class="form-group input"> <label class="form-control-label"  data-tag="telefon"></label>
                             <input type="tel"  name="Telefon" placeholder="+49-123-123-123" pattern="(?:(?:\+)49|0)-[0-9]{3}-[0-9]{3}-[0-9]{3}" title="Ungültige Nummer" class="form-control" required> </div>
